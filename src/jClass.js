...
window.jclass = (function() {
    ...
    var __classManager = (function() {
        ...
        */
        ...
        function addClass(classInfo) {
            ...
            var cpConstructor = cp['__constructor'].prototype;
            cpConstructor['__class'] = cp;

            if(classInfo.hasOwnProperty('parent')) {
                cp['__parent'] = classInfo['parent'];
                cpConstructor['jsuper'] = function () {
                    var superClass = __classManager.getClass(this['__class']['__parent']);
                    superClass['__constructor'].apply(this, arguments);
                };
                __utils.decorate(cpConstructor['jsuper'], cpConstructor, ['jsuper']);
            }
        }
    ...
    //调用父类的构造函数
    function superCall(scope) {
        var superClass = __classManager.getClass(scope['__class']['__parent']);
        superClass['__constructor'].apply(scope, Array.prototype.slice.call(arguments, 1));
    }
    ...
    var ret = instanceClass;
    ret['__jclass'] = 'jclass';
    ret['define'] = defineClass;
    ret['jsuper'] = superCall;
    ret['getClassName'] = getClassName;
    ret['getClassParentName'] = getClassParentName;
    return ret;
})();
